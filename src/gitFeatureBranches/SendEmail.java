...
public class SendEmail
{
   ...
   public static void generateAndSendEmail(String Betreff, String Sender, String Empfänger, String Text, String Gruppen,
			String Einheiten) throws AddressException, MessagingException
   {
	  ...
	  // InternetAddress("freexplays01@gmail.com"));
